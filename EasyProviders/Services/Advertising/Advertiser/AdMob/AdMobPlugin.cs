...
namespace EasyProviders.Services.Advertising.Advertiser.AdMob {
    public sealed class AdMobPlugin : AdvertiserPlugin, IAvertiser {

        private AdMobPlugin() : base() {
            this.Type = AdvertiserType.AdMob;
        }
        ...
        public override bool IsAdTypeSupported(AdType adType) {
            switch (adType) {
                ...
                case AdType.VIDEO: return false;
                case AdType.V4VC: return false;
                case AdType.NONE: return false;
